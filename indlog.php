  ...
  <div class="maindiv">
    <div class="fomdiv1">
      <form action="ind_log.php" method="post" class="login ">
        ...
        <legend class="legend">INDIVIDUAL LOGIN</legend>
        <div class="input">
          <input name="uname" type="text" placeholder="Username" required value="web.devang" />
          <span><i class="fa fa-lock"></i></span>
        </div>
        <div class="input">
          <input id="pass" name="password" type="password" placeholder="Password" value="password" /><button id="hide" onclick="hidee()" class="btn btn-info" type="button"> Show</button>
          <span><i class="fa fa-lock"></i></span>

        </div>
        <span style="margin-left:10px;margin-top:0px;font-size:16px;"><a style="text-decoration:none;color:#0a66c2;" href="forget_password?fp=ind">Forgot Password ?</a></span>
